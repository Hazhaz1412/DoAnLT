Run app.py file to launch program

SQL===============================
USE [master]
GO

/****** Object:  Database [Bakery]    Script Date: 6/11/2024 11:50:02 PM ******/
CREATE DATABASE [Bakery]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Bakery', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.HUANPC\MSSQL\DATA\Bakery.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Bakery_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.HUANPC\MSSQL\DATA\Bakery_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Bakery] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [Bakery] SET RECOVERY FULL 
GO
...
ALTER DATABASE [Bakery] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [Bakery] SET QUERY_STORE = ON
GO

ALTER DATABASE [Bakery] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
